package com.sparta.pracspring_blog.aop;
...
public class RoleCheckAop {
    ...
    @Pointcut("execution(* com.sparta.pracspring_blog.service.PostService.updatePost(..))")
    private void updatePost() {}

    @Pointcut("execution(* com.sparta.pracspring_blog.service.PostService.deletePost(..))")
    private void deletePost() {}

    @Pointcut("execution(* com.sparta.pracspring_blog.service.CommentService.updateComment(..))")
    private void updateComment() {}

    @Pointcut("execution(* com.sparta.pracspring_blog.service.CommentService.deleteComment(..))")
